...
public:
    void addItem() {
        ...
        getline(cin, item.name);  // Using getline to allow spaces in item name
        cout << "Enter quantity: ";
        cin >> item.quantity;
        cout << "Enter price per item: ";
        cin >> item.price;
        items.push_back(item);  // Corrected: add the item to the list
    ...
    void removeItem() {
        ...
        getline(cin, name);  // Using getline to allow spaces in item name
        bool found = false;
